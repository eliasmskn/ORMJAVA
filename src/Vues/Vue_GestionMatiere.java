...
public class Vue_GestionMatiere extends JFrame implements ActionListener 
{		
			//Les Pannels
			...
			private JLabel lbMenu = new JLabel("Menu gestion matiere");
			...
			private JLabel lbtitreajout = new JLabel("Ajout d'une matiere");
			...
			// panel lister
			private JLabel lbtitrelister = new JLabel("Liste des matieres");
			...
			private JLabel lbtitreasupp = new JLabel("Suppression d'une matiere");
			...
			private JLabel lbResultat = new JLabel("Resultat :");
			 ...
			 public Vue_GestionMatiere() 
			{
				this.setTitle("Gestion des matieres ");
				...
				this.panelAjouter.add(new JLabel());
				this.panelAjouter.add(new JLabel("libelle Matiere :", SwingConstants.CENTER));
				this.panelAjouter.add(this.tfLibelle);
				this.panelAjouter.add(new JLabel());
				this.panelAjouter.add(new JLabel());
				...
				this.panelModifier.add(new JLabel("libelle Matiere :", SwingConstants.CENTER));
				this.panelModifier.add(this.tfLibelle1);
				this.panelModifier.add(new JLabel());
				this.panelModifier.add(new JLabel());
			 ...
			 private void remplirCBX() 
				...
				public void actionPerformed(ActionEvent e) 
				{
					...
					else if(e.getSource() == this.btSupp)
					{
						...
						this.lbResultat.setText("Les matieres supprimés sont :" +nb);
